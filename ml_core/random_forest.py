...
def main():
    ...
    parser.add_argument(
        "--n-estimators", type=int, default=100, help="Количество деревьев"
    )
    parser.add_argument(
        "--max-depth", type=int, default=10, help="Максимальная глубина деревьев"
    )
    parser.add_argument(
        "--min-samples-split",
        type=int,
    ...
    parser.add_argument(
        ...
        type=str,
        default="sqrt",
        help="Количество признаков для рассмотрения",
    )
    parser.add_argument(
